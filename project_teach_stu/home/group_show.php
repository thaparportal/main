...
<html lang="en" class="no-js">
			...
			<div class="content-wrap">
				<div class="content">
					<header class="c-header">
						...
						<h1>Group List<span><?php echo $scode; echo "   ";echo $sname;?></span></h1>
						<table>
					<thead>
						<tr>
							<th>Group</th>
	...
	$lecgroup='';	
						while($r=mysqli_fetch_array($result))
		{
			...
			{
				$group1="<a href='student_show.php?group=$group&scode=$scode&tlp=$tlp'>$group</a>";
	...
	if($lecgroup!='')
	{
	$lecgroup1="<a href='student_show.php?scode=$scode&tlp=l&group=$lecgroup'>$lecgroup</a>";
